...
from src.lib.domains.EventScannerState import EventScannerState
...
class EventScanner:
    ...
    def scan(self, start_block, end_block, start_chunk_size=20) -> Tuple[list, int]:
        ...
        while current_block <= end_block:
            ...
            # Print progress bar
            # print(f"Current block: {current_block} ({end_block_timestamp}), blocks in a scan batch: {chunk_size}, events processed in a batch {len(new_entries)}")
